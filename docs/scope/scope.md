...
_Re-skin pending: spec 0005 was revised 2026-09-07 to the modern cinematic direction (neutral primary, amber as `--rating`, `1rem` radius, one sans family, glass + scrim recipes). Re-run `/develop design system & UI foundation` for the re-skin pass (build plan steps R1 to R5); component APIs and all ACs are unchanged._
