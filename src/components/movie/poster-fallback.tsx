...
export function PosterFallback({ label }: { label: string }) {
  return (
    <div className="bg-muted text-muted-foreground flex aspect-2/3 w-full flex-col items-center justify-center gap-2 overflow-hidden rounded-lg p-3 text-center">
